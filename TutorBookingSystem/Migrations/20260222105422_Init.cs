        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatesPerHour = table.Column<double>(type: "float", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "QualificationTutor",
                columns: table => new
                {
                    QualificationsQualificationId = table.Column<int>(type: "int", nullable: false),
                    TutorsTutorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QualificationTutor", x => new { x.QualificationsQualificationId, x.TutorsTutorId });
                    table.ForeignKey(
                        name: "FK_QualificationTutor_Qualifications_QualificationsQualificationId",
                        column: x => x.QualificationsQualificationId,
                        principalTable: "Qualifications",
                        principalColumn: "QualificationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QualificationTutor_Tutors_TutorsTutorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QualificationTutor_TutorsTutorId",
                table: "QualificationTutor",
